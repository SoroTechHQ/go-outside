...
import { getOrganizerDashboardData, getOrganizerHashtagPerformance } from "../../../../../app/organizer/_lib/dashboard";
...
export async function GET() {
  ...
  return NextResponse.json({ rows: getOrganizerHashtagPerformance(dashboard) });
}
