...
const MAX_BYTES = 10 * 1024 * 1024; // 10 MB — high-res banners for event pages
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[POST /api/upload/banner] bucket setup failed", err);
    return jsonError(500, "Banner storage is not configured");
  }
