    ...
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center overflow-hidden bg-transparent p-6 text-white">
          ...
          >
                  ...
                  <div className="bg-black/95 py-1">
                    {commandSuggestions.map((suggestion, index) => (
                      <motion.div
                        ...
                        animate={{ opacity: 1 }}
                        className={cn(
                          "flex cursor-pointer items-start gap-2 px-3 py-2 text-xs transition-colors",
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <div className="text-[11px] text-white/40">{suggestion.description}</div>
                        </div>
            ...
            <div className="p-4">
              <Textarea
                ref={textareaRef}
                className={cn(
                  "min-h-[60px] w-full resize-none border-none bg-transparent px-4 py-3 text-sm text-white/90 placeholder:text-white/20 focus:outline-none",
                )}
      ...
      <AnimatePresence>
        {isTyping ? (
          <motion.div
            animate={{ opacity: 1, y: 0 }}
            className="fixed bottom-8 left-1/2 z-10 flex -translate-x-1/2 items-center gap-3 rounded-full border border-white/[0.05] bg-white/[0.02] px-4 py-2 shadow-lg backdrop-blur-2xl"
            exit={{ opacity: 0, y: 20 }}
            initial={{ opacity: 0, y: 20 }}
          >
      ...
      {recentCommand ? (
        <div className="sr-only">{recentCommand}</div>
      ) : null}
    </div>
  );
}
