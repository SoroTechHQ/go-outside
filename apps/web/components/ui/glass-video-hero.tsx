  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="absolute top-4 right-4 z-20 p-2.5 rounded-[10px] backdrop-blur-xl border border-[rgba(47,143,69,0.5)] bg-[rgba(20,60,30,0.4)] text-white hover:bg-[rgba(20,60,30,0.6)] transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-[#2f8f45]"
      >
      ...
      <div className="relative z-10 flex flex-col items-center text-center mt-32 px-6">
        {/* Tagline Pill */}
        <div className="inline-flex items-center gap-2.5 h-[38px] px-3.5 rounded-[10px] backdrop-blur-xl border border-[rgba(47,143,69,0.5)] bg-[rgba(20,60,30,0.4)] shadow-[0_0_20px_rgba(47,143,69,0.15),inset_0_1px_0_rgba(255,255,255,0.08)]">
          <span className="bg-[#2f8f45] text-white font-medium text-xs px-2.5 py-1 rounded-[6px] shadow-[0_0_8px_rgba(47,143,69,0.4)]">
            New
          </span>
          <span className="font-medium text-sm text-white tracking-wide">
            Say Hello to GoOutside v1.0
          </span>
        </div>

        {/* Headline */}
        <h1 className="text-white text-5xl lg:text-[96px] leading-[1.05] tracking-[-0.02em] mt-8 max-w-5xl font-normal italic" style={{ fontFamily: "'DM Serif Display', serif" }}>
          Book your perfect stay
          <br className="hidden lg:block" />
          instantly{" "}
          <em className="italic mx-[0.08em] relative inline-block text-[#4ade80]">
            and
          </em>{" "}
          hassle-free
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 mt-8">
          <button className="px-8 py-3.5 rounded-[10px] bg-[#2f8f45] text-white font-medium text-base hover:brightness-110 transition-all shadow-lg shadow-[rgba(47,143,69,0.25)]">
            Book a Free Demo
          </button>
