...
export function MessagesPreviewShell({ label = "Opening your inbox..." }: { label?: string }) {
        ...
        <div className="go-stream-chat">
          <aside className="go-stream-chat__sidebar">
            <div className="go-stream-sidebar__header">
              <div>
                <p className="go-stream-sidebar__eyebrow">Messages</p>
                <h1 className="go-stream-sidebar__title">Inbox</h1>
              </div>
            </div>
            {hasConversations
          ...
          <section className="go-stream-chat__thread">
            <div className="go-stream-empty go-stream-empty--thread">
              ...
              <div>
                ...
                <p className="go-stream-empty__copy">{label}</p>
              </div>
            </div>
          </section>
        </div>
